...
namespace TriggersTools.DiscordBots.Extensions {
	...
	public static class ExceptionExtensions {
		...
		/// <summary>
		/// Gets the innermost exception in this exception. Can return itself.
		/// </summary>
		/// <param name="ex">The exceptino to check.</param>
		/// <returns>The innermost exception, or this exception if there are no inner exceptions.</returns>
		public static Exception GetInnermost(this Exception ex) {
			return ex.GetInnerExceptions().LastOrDefault() ?? ex;
		}
