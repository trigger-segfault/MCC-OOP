...
namespace Discord.Commands {
	...
	public class RequiresUserPermissionAttribute : PreconditionAttribute {
		/// <summary>
		...
		/// </param>
		public RequiresUserPermissionAttribute(GuildPermission permission) {
		...
		///     specified by ORing the permissions together.
		/// </param>
		public RequiresUserPermissionAttribute(ChannelPermission permission) {
