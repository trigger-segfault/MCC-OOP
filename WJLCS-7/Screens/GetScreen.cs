...
namespace WJLCS.Screens {
	...
	/// </remarks>
	public abstract class GetScreen {
		...
		/// <summary>
		/// Gets the interpreter mode to use for the screen.
		/// </summary>
		public virtual InterpreterMode InterpreterMode => InterpreterMode.None;
		...
		/// <summary>
		/// Constructs the base <see cref="GetScreen"/>.
		/// </summary>
		/// <param name="filePath">The filepath of the screen text.</param>
		protected GetScreen(string filePath) {
