...
namespace WJLCS.Enigma {
	...
	public class SetupArgs {
		...
		/// </summary>
		public static int MaxRotorCount => RotorCollection.MaxRotorCount;
		...
		/// <summary>
		/// The number of characters to reset after.
		/// </summary>
		...
		public void Validate() {
			...
			if (RotorCount < 1)
				throw new ArgumentException("Rotor count is less than 1!", nameof(RotorCount));
			if (RotorCount > MaxRotorCount)
				throw new ArgumentException($"Rotor count is greater than maximum number of rotors " +
											$"({MaxRotorCount})!", nameof(RotorCount));
			if (ResetAfter < 1)
				throw new ArgumentException("Reset after is less than 1!", nameof(ResetAfter));
		}
